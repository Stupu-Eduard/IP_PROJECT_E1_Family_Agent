...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1005, 150.00, '2025-09-30 20:00:00', (SELECT id FROM users WHERE email = 'mihai.popescu@email.com'), (SELECT id FROM locations WHERE store = 'Restaurant Vivo' LIMIT
 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
-- OCTOMBRIE 2025
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1006, 320.00, '2025-10-05 17:45:00', (SELECT id FROM users WHERE email = 'radu.ionescu@email.com'), (SELECT id FROM locations WHERE store = 'Kaufland Pacurari' LIMI
T 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1007, 45.00, '2025-10-14 15:20:00', (SELECT id FROM users WHERE email = 'elena.ionescu@email.com'), (SELECT id FROM locations WHERE store = 'Starbucks Palas' LIMIT 
1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1008, 180.00, '2025-10-18 10:00:00', (SELECT id FROM users WHERE email = 'cristian.popa@email.com'), (SELECT id FROM locations WHERE store = 'Kaufland Pacurari' LIM
IT 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1012, 135.00, '2025-11-15 19:30:00', (SELECT id FROM users WHERE email = 'cristian.popa@email.com'), (SELECT id FROM locations WHERE store = 'Restaurant Vivo' LIMIT
 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1018, 55.00, '2025-12-15 13:00:00', (SELECT id FROM users WHERE email = 'mihai.popescu@email.com'), (SELECT id FROM locations WHERE store = 'Farmacie Catena' LIMIT 
1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
-- IANUARIE 2026
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1021, 450.00, '2026-01-02 11:00:00', (SELECT id FROM users WHERE email = 'ana.popescu@email.com'), (SELECT id FROM locations WHERE store = 'Kaufland Pacurari' LIMIT
 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1023, 35.00, '2026-01-12 10:00:00', (SELECT id FROM users WHERE email = 'sofia.popescu@email.com'), (SELECT id FROM locations WHERE store = 'Starbucks Palas' LIMIT 
1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
...
INSERT INTO expenses (id, amount, expense_date, user_id, location_id)
VALUES (1024, 150.00, '2026-01-18 18:00:00', (SELECT id FROM users WHERE email = 'cristian.popa@email.com'), (SELECT id FROM locations WHERE store = 'Farmacie Catena' LIMIT
 1));
INSERT INTO expense_items (item_name, amount, expense_id, category_id) VALUES
