...
public class ExpenseSearchController {
    ...
    @PostMapping
    public ResponseEntity<List<EmbeddedExpense>> semanticSearch(@RequestBody SearchRequest request) {
    ...
    @PostMapping("/filter")
    public ResponseEntity<List<EmbeddedExpense>> filteredSearch(@RequestBody FilterRequest request) {
