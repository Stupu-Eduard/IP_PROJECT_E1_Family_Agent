...
describe('ExpenseForm Component', () => {
    beforeEach(() => {
        vi.clearAllMocks()
        // AM SCOS vi.useFakeTimers() de aici
    })
    ...
    it('4. Salvează o cheltuială cu succes și resetează formularul', () => {
        // Activăm fake timers DOAR pentru acest test
        vi.useFakeTimers()
        ...
        // Avansează timpul pentru setTimeout-ul din componentă
        act(() => {
            vi.advanceTimersByTime(1000)
        })

        // Fără waitFor! Assert-urile merg sincron imediat după ce timpul a "trecut"
        expect(screen.getByText('Cheltuială adăugată cu succes!')).toBeInTheDocument()
        expect(amountInput).toHaveValue(null) // Resetat la gol
